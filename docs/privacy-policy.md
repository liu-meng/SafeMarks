...
- Replace the contact placeholder below with your real support email or website.
- Host this document at a public HTTPS URL and use that URL in Chrome Web Store and Microsoft Edge Add-ons.
...
Support contact before publishing: `helloXXworld@qq.com`
...
- 把上面的联系方式替换成真实支持邮箱或官网地址。
- 将本文托管到公开的 HTTPS 地址，并把该地址填写到 Chrome Web Store 和 Edge Add-ons。
